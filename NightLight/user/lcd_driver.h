...
#define LCD_CS_H 			FPTA->PSOR = BIT13   
#define LCD_CS_L 			FPTA->PCOR = BIT13  

#define LCD_RST_H 		FPTD->PSOR = BIT5
#define LCD_RST_L 		FPTD->PCOR = BIT5  

#define LCD_RS_H 			FPTD->PSOR = BIT0  
#define LCD_RS_L 			FPTD->PCOR = BIT0

#define LCD_SDA_H 		FPTD->PSOR = BIT2
#define LCD_SDA_L 		FPTD->PCOR = BIT2

#define LCD_SCK_H 		FPTD->PSOR = BIT3
#define LCD_SCK_L 		FPTD->PCOR = BIT3
...
// PTC17   C16      C13      C12  
// PTC9    C8       A5       A4
#define ROM_CS_H 			FPTC->PSOR = BIT17   
#define ROM_CS_L 			FPTC->PCOR = BIT17  

#define ROM_SCK_H 		FPTC->PSOR = BIT16
#define ROM_SCK_L 		FPTC->PCOR = BIT16 

#define ROM_OUT_DATA  (FPTC->PDIR & BIT13)  

#define ROM_IN_H 			FPTC->PSOR = BIT12
#define ROM_IN_L 			FPTC->PCOR = BIT12
