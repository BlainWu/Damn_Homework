...
//PTA13	PTD5 PTD0 PTD2 PTD3  
	...
	FGPIOA->PSOR |= BIT13;
	FGPIOA->PDDR |= BIT13;
	PORTD->GPCLR = 0x002D0100; // PTD0 2 3 5  ->GPIO
	FGPIOD->PSOR |= BIT0+BIT2+BIT3+BIT5; //output 1 
	FGPIOD->PDDR |= BIT0+BIT2+BIT3+BIT5; // PTD0 2 3 5 OUTPUT

//ROM-CS      ROM-SCK  ROM-OUT  ROM-IN 
// PTC9->17    C8->16       A5->C13       A4->C12
	SIM->SCGC5 |= SIM_SCGC5_PORTC_MASK;
	PORTC->PCR[12] = 0x0100;
	PORTC->PCR[13] = 0x0100;
	PORTC->PCR[16] = 0x0100;
	PORTC->PCR[17] = 0x0100;
	FGPIOC->PSOR |= BIT12+BIT16+BIT17;
	FGPIOC->PDDR |= BIT12+BIT16+BIT17;
	FGPIOC->PDDR &=~BIT13;
#endif
}
